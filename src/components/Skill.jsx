...
export const Skill = () => {
    ...
    return(
        ...
        >
            ...
            <div className='py-8'>
                <p className='text-xl pl-4 pb-4'>・Python3エンジニア認定基礎試験</p>
                <p className='text-xl pl-4 pb-4'>・全商 情報処理検定 2級<br/>　ビジネス部門</p>
                <p className='text-xl pl-4 pb-4'>・全商 日本語ワープロ検定 準2級</p>
                <p className='text-xl pl-4'>全商 文書デザイン検定 2級</p>
            </div>
